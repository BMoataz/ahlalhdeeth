 ...
 */
public class SubjectsFragment extends android.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (!Check) {
                    ...
                    OpenActivity.putExtra("url", links.get(i));
        ...
        listview.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                Log.i("the log", "you are in the item" + visibleItemCount);
                Log.i("the log", "you are in the item" + lastVisibleItem);
    ...
    public class FetchLinkTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                Elements td1Items = document.select("div.smallfont span[style*=cursor]"); //subject author
                Elements td2Items = document.select("td.alt2 div.smallfont");//last modified author and date
                ...
                for (Element tdItem : tdItems) {
                    ...
                    links.add("http://www.ahlalhdeeth.com/vb/" + tdItem.attr("href"));
                    i++;
                }
                AideIf = values.size();
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (ProgOrNot == 1) {
                mForecastAdapter = new SubjectsFragment.CustomArrayAdapter(getActivity(),
